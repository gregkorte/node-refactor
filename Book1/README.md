...
The purpose of this book is to provide a basic introduction to the syntax of Node.js and the structure of Node.js programs.
...
### Installations
|[Installations for Book 1](./installations.md) :computer:|
|--|
...
|:-:|:-:|:-:|:-:|
|1|[Setting up a console app](./Chapter1/setting-up-console-app.md)|[Project Setup](./chapters/extravert-intro.md)|[Project Requirements](./chapters/red-and-abe-requirements.md)|
|2|[Strings, Console](./Chapter1/interacting-with-console.md)|[Main Menu](./chapters/extravert-main-menu.md)|[Calculated Properties](./chapters/red-and-abe-properties.md)<br><sub style="font-size: 0.85rem;">#get #set</sub>|
|3|[Loops and Conditions](./Chapter1/conditionals-and-loops.md)|[Menu Options](./chapters/extravert-implement-menu.md)<br><sub style="font-size: 0.85rem;">#ternaries</sub>||
